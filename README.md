...
**Version 2.1.2** - A professional dual-channel, real-time guitar effects processor for the [Electro-Smith Daisy Seed](https://www.electro-smith.com/daisy/daisy-seed) with comprehensive web-based control and browser-based firmware flashing.

## 🎸 Features

### New in v2.1.2
- **Maximum Stability:** Reverted memory layout to SRAM for guaranteed boot reliability.
- **Improved Connectivity:** Optimized audio block size (48 samples) to ensure reliable USB connection.
